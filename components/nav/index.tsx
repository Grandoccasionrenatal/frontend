                          ...
                          <NavigationMenuContent>
                            <div className="w-max min-w-[16rem] sm:min-w-[22rem] flex flex-col p-4 gap-4">
                              <NavigationMenuLink asChild>
                                <Link href="/products" className="flex flex-row items-center gap-2 font-[600] hover:text-orange-1 transition-colors ease-in-out duration-200">
                                  ...
                                  <svg
                                    ...
                                    strokeWidth={1.5}
                                    stroke="currentColor"
                                    className="w-5 h-5 text-black-1/80"
                                  >
                                    <path
                                      strokeLinecap="round"
